    ...
    def interactive_mode(self):
        while(True):
            ...
            if(command=='Q' or command=='q' or command=='exit'):                     # quit the program
                ...
                # get people's names
                print("Please enter all participants' names in English, splited with spaces:")
                people_string = input()
                people_string = re.sub("[^A-Za-z]", " ", people_string)
                people_list = people_string.split()
                self.add_new_people(people_list)
            ...
            # show result
                ...
                self.color_print(Color.WARNING.value, "Please enter either \"new event\" or \"q\" or \"result\"")
